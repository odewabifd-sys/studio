      ...
      <main className="flex-grow container py-8">
        <Card>
          ...
          <CardContent className="prose max-w-none">
            ...
            <p>Welcome to Menda. These Terms of Service ("Terms") govern your use of our website, mobile application, and services (collectively, the "Services"). By using our Services, you agree to these Terms.</p>

            <h2>2. Services Description</h2>
            <p>Menda is a platform that connects customers with independent artisans for various services. We are not an employer of artisans and are not responsible for their conduct or the quality of their work.</p>
            ...
            <p>To the fullest extent permitted by law, Menda shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly.</p>
